...
|-----------|-------|-------------|
| **Skills** | 94 | Portable workflows for common tasks (`proofread`, `latex`, `literature`, etc.) |
...
94 skills available. Key examples: `proofread`, `latex`, `pre-submission-report`, and more. Use `/name` in Claude, `$name` in Codex, or natural language; see [`docs/availability.md`](docs/availability.md).
<!-- SKILLS-SUMMARY:END -->
...
├── skills/                      # 94 client-neutral workflows
