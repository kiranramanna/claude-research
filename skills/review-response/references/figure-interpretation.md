...
A scientific figure is incomplete until the text answers three questions:
...
galaxy-dawn/claude-scholar `results-analysis` skill (figure-interpretation.md reference).
