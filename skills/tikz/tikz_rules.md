...
Companion to `SKILL.md` — read this once, then the SKILL walks you through applying it.
...
See `SKILL.md` Step 2 / Pass 6 for the `\tikzset{every node/.append style={draw=red, very thin}}` approach. Do NOT rely on visually inspecting the rendered PDF.
