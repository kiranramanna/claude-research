...
- **Returns nothing on first use** — If `~/vault/meetings/` doesn't exist yet or has no `.md` files, list returns an empty array. This is normal before the first recording.
