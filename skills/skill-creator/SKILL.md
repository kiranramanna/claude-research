...
Full eval workflow (spawn runs, draft assertions, grade, launch viewer): [`references/eval-workflow.md`](references/eval-workflow.md)
...
Eval-driven description tuning for better skill triggering: [`references/description-optimization.md`](references/description-optimization.md)
...
Adaptations for Claude.ai and Cowork: [`references/platform-notes.md`](references/platform-notes.md)
